...
public static class TeaPieFunctionsExtensions
{
    ...
    public static void RegisterFunction<T>(this TeaPie teaPie, string name, Func<T> func)
    ...
    /// <param name="name">The name under which the function will be registered.</param>
    /// <param name="func">Predicate of registered function.</param>
    public static void RegisterFunction<T1, T>(this TeaPie teaPie, string name, Func<T1, T> func)
       => teaPie._functions.Register(name, func);
    ...
    /// <param name="name">The name under which the function will be registered.</param>
    /// <param name="func">Predicate of registered function.</param>
    public static void RegisterFunction<T1, T2, T>(this TeaPie teaPie, string name, Func<T1, T2, T> func)
        => teaPie._functions.Register(name, func);
    ...
    public static T? ExecFunction<T>(this TeaPie teaPie, string name, params object[] args)
        => teaPie._functions.Execute<T>(name, args);
    ...
    /// <param name="teaPie">The current context instance.</param>
    /// <param name="name">The name of the function to retrieve.</param>
    public static T? ExecFunction<T>(this TeaPie teaPie, string name)
       => teaPie._functions.Execute<T>(name);
}
