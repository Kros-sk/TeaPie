...
public sealed class ApplicationBuilder
{
    ...
    private string? _structuredRequestsFile;
        ...
        string? structuredRequestsFile = null)
    {
        ...
        _structuredRequestsFile = structuredRequestsFile;
        return this;
    }
    ...
    private void ConfigureServices()
        => _services.AddTeaPie(
            _isCollectionRun,
            () => _services.ConfigureLogging(_minimumLogLevel, _pathToLogFile, _minimumLevelForLogFile, _structuredRequestsFile));
